...
project and contributed to its conceptual development, interpretation, and review and
editing. All authors discussed the results, reviewed the final manuscript, and approved
its submission.

Anthropic's Claude Fable 5, accessed through the Claude interface, and OpenAI's
GPT-5.6, accessed through the ChatGPT and Codex interfaces, were used as assistive
tools for exploring and checking selected intermediate derivations in the appendices,
bibliographic checking, language and spelling revision, manuscript formulation, and
support with LaTeX, analysis code, and figure code. The tools were not treated as
sources of scientific evidence. All AI-assisted derivations, calculations, analysis
code, figure code, citations, and text were independently reviewed, verified, and
revised by the authors. The authors take full responsibility for the scientific content
