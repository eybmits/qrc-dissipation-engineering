...
language and spelling revision, manuscript formulation, LaTeX formatting, and debugging
of software and figure code. The tools were not treated as sources of scientific
evidence. All AI-assisted derivations, calculations, code-debugging suggestions, and text
were independently reviewed, verified, and revised by the authors. The authors
take full responsibility for the scientific content and final manuscript.
