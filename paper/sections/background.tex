...
\subsection{Generator-level dissipative architecture}

Dissipative architecture has two operational coordinates. A \emph{jump
family} changes which combinations of the system
couple directly to the environment. A \emph{rate profile} redistributes the
available coupling weight within a fixed family.
...
\end{scope}
\end{tikzpicture}
\caption{\textbf{Dissipative architecture separates two complementary design
coordinates.}
