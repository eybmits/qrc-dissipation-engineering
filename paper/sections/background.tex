...
system combinations couple directly to the environment. \emph{(c)} Within
collective relaxation, alternative rate profiles illustrate how redistributing
the coupling weight can raise or lower STM capacity relative to the
reference profile.
\emph{(d)} Highlighted cells mark the two principal coordinate slices.
Pale-gray cells show other combinations. Panels (a) through (c) show illustrative
STM capacity trends, not fitted task data.}
\label{fig:space}
\end{figure*}
