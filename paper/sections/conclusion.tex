...
changes which parts of the input history the measured output can recover. The
system--environment connection is therefore part of the reservoir's
...
The result brings a familiar principle of dissipation engineering, designing
the system--environment interaction, into temporal quantum computation
