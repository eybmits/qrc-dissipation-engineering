...
The clearest recurring comparison is between uniform local and collective
relaxation. With uniform local relaxation, each qubit couples to its own decay
channel. With collective relaxation, the environment couples directly to one
...
environment. Dynamical diagnostics and a gradual path between uniform local and
collective relaxation support this channel-selectivity picture, but do not
establish a unique microscopic mechanism.

The ordering between collective and uniform local relaxation persists after longer washout, across the
