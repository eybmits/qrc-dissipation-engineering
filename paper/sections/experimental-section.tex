\section{\texorpdfstring{Computational consequences of\\
dissipative architecture}{Computational consequences of dissipative architecture}}
\label{sec:performance}

Section~\ref{sec:model} defined dissipative architecture through the jump-family and
...
preparation budget do the differences created by dissipative architecture become
