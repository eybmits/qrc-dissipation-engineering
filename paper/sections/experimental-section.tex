...
\captionof{figure}{\textbf{Rate profiles tune memory within a chosen relaxation
family.}
...
\captionof{figure}{\textbf{Grouped measurements reveal memory differences with
fewer preparations.}
...
At finite budgets, large symbols and bars show means and simultaneous
\(95\%\) intervals.}
\label{fig:sampling}
\end{minipage}
\end{figure*}
