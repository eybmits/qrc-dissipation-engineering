...
Uniform local relaxation is the reference: one equal-rate lowering channel per
qubit. The \emph{local-relaxation family} also contains unequal, learned, and
input-adaptive profiles. The main comparison uses equal-phase collective
relaxation, one rank-one channel with fixed \(c_i=1\)
(Appendix~\ref{app:shared}); unless noted otherwise, the term refers to this
channel. Profile-optimized models instead learn within-family coefficients.
