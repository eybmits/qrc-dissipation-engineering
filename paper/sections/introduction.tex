...
channel. With independent relaxation, each qubit has its own route into the
environment. With shared relaxation, one channel acts directly on a collective
...
The clearest recurring contrast is between shared and independent relaxation.
A shared channel leaves more recent input history accessible to the linear
...
remains when the initial settling period, or washout, is extended until the
tested dependence on the starting state has vanished to numerical precision.
