...
the comparison in a reset-encoded reservoir. At input
...
400 test rows identical to W200. Local and collective reservoirs share every input, target,
...
separate \(N=6\) replication. Pale marks show pairs. Large symbols and bars
