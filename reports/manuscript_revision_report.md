...
- Compressed the argument into a short problem--concept--evidence--implication
  sequence.
- Presented the problem, the dissipator-geometry concept, the evidence
...
- Reorganized the introduction into five functional paragraphs: temporal
  processing problem, established work and gap, dissipator-geometry concept,
...
### 2. Dissipator geometry and controlled comparison
...
### 3. What changes when dissipator geometry changes?
...
- Ends with a bounded design implication: dissipator geometry should be
...
|---|---|---|
| Four-panel concept map | Main Figure 1 | Jump family and rate profile are complementary dissipator-geometry coordinates. |
